        ...
        <div class="anim-slide anim-slide-fourth">
            <div class="slide__flex">
                <div class="slide__animate animate2">
                    <h1 class="text9" style="font-size: 3.0rem;color: white; z-index: 100; font-style: normal; text-shadow: rgb(114 114 114) 2px 1px;">¡ Hola <span style="color: #BAD305; z-index: 100;"><%= ViewData["Nombre"] %></span>! hemos evaludo tu caso y tu diagnóstico es el siguiente:</h1>
                    <br />
