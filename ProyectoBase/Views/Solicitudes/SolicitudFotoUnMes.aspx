...
<main id="main">
    <br />
        <form style="background: #F7F7F7;"  method="post" enctype="multipart/form-data" id="formSolicitud" action="<%: Url.Content("~/Solicitudes/SolicitudFotoUMesEnviar") %>">
                                ...
                                <div class="card border-left-warning shadow ">
                                    <div class="card-body">
                                        <div style="text-align: center;">
                                            <h1 style="color: #858585; font-family: 'Open Sans', sans-serif; font-style: inherit;">Fotografías Un Mes Desupúes Solicitud N°<%= ViewData["idSolicitud"]%> </h1>
