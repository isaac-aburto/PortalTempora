...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- ======= About Section ======= -->
        ...
        <form style="background: #F7F7F7;"  method="post" action="<%: Url.Content("~/Pacientes/EditarPaciente") %>">
        ...
        <section id="about" class="about" style="    margin-top: 8pc;">
            ...
            <div class="card border-secondary <%--border-0--%> shadow rounded-lg mt-5" style="margin-top: -55px; background-color: #e3e3e3;">
                <div class="container" data-aos="fade-up">
                    <input hidden name="idPaciente" value="<%= ViewData["id"]%>"/>
                    <div class="row">
                        <div class="card-body" style="    margin-top: -5pc;">
                        <div class="card border-left-warning shadow ">
                        <div class="card-body">
                            <h1 style="color: #858585; font-family: 'Open Sans', sans-serif; font-style: inherit;">Editar Paciente</h1>
                            <br />
                            <div style="text-align: center;"></div>                                                
                            <div class="form-row">
                                <input hidden name="txtIdPaciente" value="<%= ViewData["txtIdPaciente"] %>"/>
